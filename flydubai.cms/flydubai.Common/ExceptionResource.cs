...
namespace flydubai.Common
{
    ...
    public static class ExceptionResource
    {
        ...
        public static string GetExceptionMessage(string key)
        {
            try
            {
                return ObjectFactory.GetInstance<IExceptionCache>().GetExceptionMessage(key);
            }
            catch (Exception)
            {
                return null;
        ...
        public static string GetWebsettingMessage(string key)
        {
            try
            {
                return string.Format(key, ObjectFactory.GetInstance<IAppSettingCache>().GetWebSetting("InfantMincutoff"));
            }
            catch (Exception)
            {
                return null;
        ...
        public static string ERR3414 { get { return "This voucher cannot be used for this booking"; } }

        public static string DuplicateVoucher { get { return "Cannot use this voucher ,this is already added"; } }
        ...
        public static string PassengerInfantTooYoung { get { return GetWebsettingMessage(GetExceptionMessage("PassengerInfantTooYoung")); } }
        ...
        public static string PassengerHasMoreThanOneInfant { get { return GetWebsettingMessage(GetExceptionMessage("PassengerHasMoreThanOneInfant")); } }
        public static string PassengerInfantMustBeAssignedToAnAdult { get { return GetWebsettingMessage(GetExceptionMessage("PassengerInfantMustBeAssignedToAnAdult")); } }
        ...
        public static string FlyingBackValidationMulticity { get { return GetExceptionMessage("FlyingBackValidationMulticity"); } }
        ...
        public static string PaymentFailureAlertPayNow { get { return GetExceptionMessage("PaymentFailureAlertPayNow"); } }
        ...
        public static string DuplicatePassport { get { return GetExceptionMessage("DuplicatePassport"); } }

        //FFP Changes
        public static string InvalidMember { get { return GetExceptionMessage("InvalidMember"); } }

        public static string PaybypointsNotAllowed { get { return GetExceptionMessage("PaybypointsNotAllowed"); } }
        public static string RedemptionNotAllowedNonFamily { get { return GetExceptionMessage("RedemptionNotAllowedNonFamily"); } }
        public static string InsufficientPoints { get { return GetExceptionMessage("InsufficientPoints"); } }
        public static string RedemptionNotAllowed { get { return GetExceptionMessage("RedemptionNotAllowed"); } }
        public static string PointsRequired { get { return GetExceptionMessage("PointsRequired"); } }
        public static string InvalidPointsEntry { get { return GetExceptionMessage("InvalidPointsEntry"); } }
        public static string ExeededMaxPoints { get { return GetExceptionMessage("ExeededMaxPoints"); } }
        public static string NothingtoPay { get { return GetExceptionMessage("NothingtoPay"); } }

        public static string AlreadyUsedFFNumErr { get { return GetExceptionMessage("AlreadyUsedFFNumErr"); } }
        public static string NotAdultFFPNumberErr { get { return GetExceptionMessage("NotAdultFFPNumberErr"); } }
        public static string NotChildFFPNumberErr { get { return GetExceptionMessage("NotChildFFPNumberErr"); } }

        public static string UnexpectedExceptionCustomer { get { return GetExceptionMessage("UnexpectedExceptionCustomer"); } }
        public static string ChooseOtherPaymentOption { get { return GetExceptionMessage("ChooseOtherPaymentOption"); } }
        public static string PointsPaymentError { get { return GetExceptionMessage("PointsPaymentError"); } }
        public static string MobileErrorMessageForNotCombinableFares { get { return GetExceptionMessage("MobileErrorMessageForNotCombinableFares"); } }
        public static string MobileErrorMessageForOutboundRedirectionPopup { get { return GetExceptionMessage("MobileErrorMessageForOutboundRedirectionPopup"); } }

        public static string UserIdOrEmailAddressRequired { get { return GetExceptionMessage("UserIdOrEmailRequired"); } }
        public static string FfpInvalidCredentials { get { return GetExceptionMessage("FfpInvalidCredentials"); } }

        public static string VoucherCannotBeUsed { get { return "This voucher cannot be used for this booking"; } }

        public static string VoucherBalanceInsufficient { get { return GetExceptionMessage("VoucherBalanceInsufficient"); } }
        public static string VoucherAlreadyUsed { get { return GetExceptionMessage("VoucherAlreadyUsed"); } }

        public static string RestrictedRouteTryAgain { get { return GetExceptionMessage("RestrictedRouteTryAgain"); } }

        public static string PaymentPostalCodeInvalid { get { return GetExceptionMessage("PaymentPostalCodeInvalid"); } }
    }
}
