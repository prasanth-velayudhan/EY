namespace flydubai.Model.OptionalExtras.Baggage
{
    ...
    /// <summary>
    /// Baggage Allowance Price
    /// </summary>
    public class BaggageAllowancePrice
    {
        ...
        /// <returns></returns>
        public bool Equals(BaggageAllowancePrice other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(BaggageAllowancePrice))
            {
                return false;
            }
            return Equals((BaggageAllowancePrice)obj);
        }
