namespace flydubai.Model.OptionalExtras.Meal
{
    ...
    /// </summary>
    public class MealAllowancePrice
    {
        ...
        /// <returns></returns>
        public bool Equals(MealAllowancePrice other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(MealAllowancePrice))
            {
                return false;
            }
            return Equals((MealAllowancePrice)obj);
        }
