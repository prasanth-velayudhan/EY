...
{
    /// <summary>
    /// Manage Booking Narrow Tab Labels
    /// </summary>
    [DisplayName("Manage Booking Narrow Tab Labels (shared between booking path and content website)")]
    public class ManageBookingNarrowTabLabels : BaseLabels, IManageBookingTabLabels
    {
