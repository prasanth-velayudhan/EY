...
{
    /// <summary>
    /// Flight Search Tab Labels
    /// </summary>
    [DisplayName("Flight Search Tab Labels (shared between booking path and content website) (includes multiple destination and full width modules)")]
    public class FlightSearchTabLabels : BaseLabels, IFlightSearchTabLabels
    {
        ...
        [DefaultValue("Add multiple destinations")]
