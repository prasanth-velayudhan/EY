...
namespace Ey.Common.Redis
{
    class CustomTypeSerializer: IExtendedTypeSerializer
    {
        #region Constructors

        public CustomTypeSerializer() : this(
    ...
    public CustomTypeSerializer(JsonSerializerSettings deserializationSettings, JsonSerializerSettings serializerSettings)
    {
